...
Route::group(['prefix' => 'products'], function() {
    ...
    Route::get('/detail/{id?}', function ($id) {
      ...
      // $product = DB::select('select * from products where id?',[$id]->first());
       ...
       $productDetails = DB::table ('product_details')->where('productId','=',$id)->get();

       $productImages = DB::table ('product_images')->where('productId','=',$id)->get();
...
Route::group(['prefix' => 'orders'], function() {
    Route::post('/addtocart', function () {
      ...
      $product_details_id = Illuminate\Support\Facades\Request::input('product_details_id');
